...
export default function IntermediateCTA() {
  return (
    <section className="cta-section bg-gradient-to-br from-yellow-500 via-amber-500 to-yellow-600 text-center py-16 px-6 shadow-lg">
      <motion.div
      ...
      >
        ...
        <p className="text-xl text-white mb-8">
          Access the complete course for only <span className="line-through text-red-500">$150</span> <strong className="text-green-600 text-2xl">$49</strong>
        </p>
